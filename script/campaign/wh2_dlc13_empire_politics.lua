...
function empire_new_game_setup()
	...
	local is_human_player_empire = false
	local number_of_playable_empire_factions = 0
	
	for i = 1, #player_faction do
		if cm:get_faction(player_faction[i]):pooled_resource_manager():resource("emp_loyalty"):is_null_interface() == false then
			is_human_player_empire = true
			number_of_playable_empire_factions = number_of_playable_empire_factions + 1
		end			
	end


	-- multiplayer
	if number_of_playable_empire_factions >= 2 then
		local loyalty_table = empire_politics_loyalty_table[default_empire_faction]
		if loyalty_table ~= nil then									
			for j = 1, #loyalty_table do						
				empire_modify_elector_loyalty(loyalty_table[j][1], "base_fealty", loyalty_table[j][2])
			end
		end
		
	-- single player
	elseif number_of_playable_empire_factions == 1 then
		local human_factions = cm:get_human_factions()
		
		for i = 1, #human_factions do	
			local loyalty_table = empire_politics_loyalty_table[human_factions[i]]
			if loyalty_table ~= nil then									
				for j = 1, #loyalty_table do						
					empire_modify_elector_loyalty(loyalty_table[j][1], "base_fealty", loyalty_table[j][2])
				end
	...
	empire_politics_events["wh_main_emp_averland"] = empire_politics_events["wh_main_emp_empire"];
	empire_politics_events["wh_main_emp_hochland"] = empire_politics_events["wh_main_emp_empire"];
	empire_politics_events["wh_main_emp_middenland"] = empire_politics_events["wh_main_emp_empire"];
	empire_politics_events["wh_main_emp_nordland"] = empire_politics_events["wh_main_emp_empire"];
	empire_politics_events["wh_main_emp_ostermark"] = empire_politics_events["wh_main_emp_empire"];
	empire_politics_events["wh_main_emp_ostland"] = empire_politics_events["wh_main_emp_empire"];
	empire_politics_events["wh_main_emp_stirland"] = empire_politics_events["wh_main_emp_empire"];
	empire_politics_events["wh_main_emp_talabecland"] = empire_politics_events["wh_main_emp_empire"];
	empire_politics_events["wh_main_emp_wissenland"] = empire_politics_events["wh_main_emp_empire"];	
	...
	for i = 1, #empire_politics_factions do
		...
		if not faction:is_null_interface() then
			...
			if is_human == false then
				...
				local elector_count_to_merc = {
					{elector = "wh_main_emp_empire", merc = "wh2_dlc13_emp_inf_greatswords_ror_0"},
					{elector = "wh2_dlc13_emp_golden_order", merc = "wh2_dlc13_emp_inf_spearmen_ror_0"},
					{elector = "wh_main_emp_averland", merc = "wh2_dlc13_emp_cav_pistoliers_ror_0"},
					{elector = "wh_main_emp_hochland", merc = "wh2_dlc13_emp_inf_handgunners_ror_0"},
					{elector = "wh_main_emp_middenland", merc = "wh2_dlc13_emp_inf_swordsmen_ror_0"},
					{elector = "wh_main_emp_nordland", merc = "wh2_dlc13_emp_inf_halberdiers_ror_0"},
					{elector = "wh_main_emp_ostermark", merc = "wh2_dlc13_emp_cav_empire_knights_ror_0"},
					{elector = "wh_main_emp_ostland", merc = "wh2_dlc13_emp_cav_empire_knights_ror_2"},
					{elector = "wh_main_emp_stirland", merc = "wh2_dlc13_emp_inf_crossbowmen_ror_0"},
					{elector = "wh_main_emp_talabecland", merc = "wh2_dlc13_emp_art_mortar_ror_0"},
					{elector = "wh_main_emp_wissenland", merc = "wh2_dlc13_emp_veh_steam_tank_ror_0"}
				}

				-- Add State troops
				local faction_cqi = faction:command_queue_index()
					
				for i = 1, #elector_count_to_merc do
					local elector_count = elector_count_to_merc[i].elector;
					local merc = elector_count_to_merc[i].merc;
					if faction_key ~= elector_count then
						cm:add_units_to_faction_mercenary_pool(faction_cqi, merc, 1)
						cm:make_diplomacy_available(faction_key, elector_count);
					end
				end
...
function empire_elector_rewards(faction, character)
    ...
    local elector_count_to_position = {
        {elector = "wh_main_emp_empire", position = "wh2_main_minister_emp_reikland", capital = "wh3_main_combi_region_altdorf"},
        {elector = "wh2_dlc13_emp_golden_order", position = "wh2_main_minister_emp_solland", capital = "wh3_main_combi_region_pfeildorf"},
        {elector = "wh_main_emp_averland", position = "wh2_main_minister_emp_averland", capital = "wh3_main_combi_region_averheim"},
        {elector = "wh_main_emp_hochland", position = "wh2_main_minister_emp_hochland", capital = "wh3_main_combi_region_hergig"},
        {elector = "wh_main_emp_middenland", position = "wh2_main_minister_emp_middenland", capital = "wh3_main_combi_region_middenheim"},
        {elector = "wh_main_emp_nordland", position = "wh2_main_minister_emp_nordland", capital = "wh3_main_combi_region_salzenmund"},
        {elector = "wh_main_emp_ostermark", position = "wh2_main_minister_emp_ostermark", capital = "wh3_main_combi_region_bechafen"},
        {elector = "wh_main_emp_ostland", position = "wh2_main_minister_emp_ostland", capital = "wh3_main_combi_region_wolfenburg"},
        {elector = "wh_main_emp_stirland", position = "wh2_main_minister_emp_stirland", capital = "wh3_main_combi_region_wurtbad"},
        {elector = "wh_main_emp_talabecland", position = "wh2_main_minister_emp_talabecland", capital = "wh3_main_combi_region_talabheim"},
        {elector = "wh_main_emp_wissenland", position = "wh2_main_minister_emp_wissenland", capital = "wh3_main_combi_region_nuln"}
    }
	...
	for i = 1, #EMPIRE_ELECTOR_REWARDS do
		...
		elseif character ~= nil and character:is_null_interface() == false and character:ministerial_position() == position then
            ...
            for k = 1, #elector_count_to_position do
                local elector_count_z = elector_count_to_position[k].elector;
                local required_minister_z = elector_count_to_position[k].position;
                local required_capital_z = elector_count_to_position[k].capital;
                if position == required_minister_z and faction_key == elector_count_z then
                    local region = cm:model():world():region_manager():region_by_key(required_capital_z);
                    local owner = region:owning_faction();
			...
			if faction:is_human() == true then
				...
				if faction:ancillary_exists(ancillary) == false then
					...
					if character == nil then
						for i = 1, #elector_count_to_position do
							local elector_count = elector_count_to_position[i].elector;
							local required_minister = elector_count_to_position[i].position;
							
							if position == required_minister and faction_key == elector_count then
								auto_assign = true;
								supress_event = true;
...
function empire_trigger_demand_return(player_key, region_key, conquerer_key, elector_faction_key)
	...
	out("");
	out("==========================================================================");
	out("FIRING EMPIRE DEMAND REGION RETURN DILEMMA FUNCTION, MODIFIED MIXU SCRIPT.");
	out("==========================================================================");
	out("");
